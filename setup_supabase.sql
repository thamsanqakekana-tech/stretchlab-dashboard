...
-- phiwe_call_timing_optimized (53 rows)
...
CREATE TABLE "phiwe_calls" (
  ...
  "call_response" TEXT,
  "result" TEXT,
  "ringing_time" NUMERIC,
  "live_talk_time" NUMERIC,
  "date" TEXT,
  "hour" INTEGER,
  "day_of_week" TEXT,
  "live_talk_min" INTEGER,
  "ringing_min" INTEGER,
  "call_length_min" INTEGER,
...
CREATE TABLE "phiwe_daily_performance" (
  ...
  "total_talk_time_min" INTEGER,
  "avg_call_duration_min" INTEGER,
  "avg_ringing_min" INTEGER,
  "engagement_rate_pct" NUMERIC,
...
-- phiwe_loyalsnap_engagement (3660 rows)
...
-- phiwe_validation_lead_details (79 rows)
