...
function getRowTooltipContent(c) {
  ...
  if (c.prevention_status === 'admin') {
    ...
    contextMsg = `Only ${c.calls_made} confirmation call(s) were made before this appointment. The confirmation follow-up was not fully applied — this cancellation is classified as preventable under the current protocol standard.`
  }
